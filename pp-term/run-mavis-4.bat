...
set SCRIPT_PATH_1=C:\Users\%USERNAME%\p-terminal\pp-term\mavis-info\info-start-mavis-4.py
...
set SCRIPT_PATH_security=C:\Users\%USERNAME%\p-terminal\pp-term\mavis-security\security_check-mavis-4.py
...
set SCRIPT_PATH_5=C:\Users\%USERNAME%\p-terminal\pp-term\mavis-4-main.py
