...
def get_project_paths_cpp():
    ...
    """
    base_dir = r"C:\Users\julia\p-terminal\pp-terminal"
    build_script = os.path.join(base_dir, "peharge-cpp-compiler", "build_mavis_cpp.bat")
    ready_indicator = os.path.join(base_dir, "peharge-cpp-compiler", "cpp_compiler_ready.txt")
...
def get_project_paths_c():
    ...
    Ermittelt das MAVIS-Projektverzeichnis und Pfade für C-Code und zugehörige Dateien.
    """
    base_dir = r"C:\Users\julia\p-terminal\pp-term"
    build_script = os.path.join(base_dir, "peharge-c-compiler", "build_mavis_c.bat")
    ready_indicator = os.path.join(base_dir, "peharge-c-compiler", "c_compiler_ready.txt")
    return base_dir, build_script, ready_indicator
