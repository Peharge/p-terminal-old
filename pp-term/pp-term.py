...
Thank you so much for using PP-Term. We truly appreciate your support ❤️""")
    ...
    print(f"""
{blue}PP-Terminal Version{reset}: 1
{blue}Peharge C++ compiler Version{reset}: 1
{blue}Peharge C compiler Version{reset}: 1
...
def handle_special_commands(user_input):
    ...
    commands = {
        ...
        "security": "mavis-security\\security_check-mavis-4.py",
        "mavis security": "mavis-security\\security_check-mavis-4.py",
        "securitycheck": "mavis-security\\security_check-mavis-4.py",
