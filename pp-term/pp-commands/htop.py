...
def is_htop_installed():
    """Checks if htop is installed."""
    try:
        subprocess.run(["wsl", "which", "htop"], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        return True
...
def install_htop():
    ...
    logging.info("[INFO] Htop has been successfully installed.")


def run_htop():
    """Runs htop."""
    logging.info("[INFO] Running Htop...")
    command = "htop"
