...
class FileExplorer(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("P-Term File Explorer SIMON")
    ...
    def load_directory_structure(self):
        directory_path = f"C:\\Users\\{os.getlogin()}\\PycharmProjects\\SIMON\\"
        self.tree.clear()
    ...
    def get_full_path(self, item):
        ...
        return os.path.join(f"C:\\Users\\{os.getlogin()}\\PycharmProjects\\SIMON\\", path)
