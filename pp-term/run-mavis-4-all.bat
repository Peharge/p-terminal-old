...
set SCRIPT_PATH_1=C:\Users\%USERNAME%\p-terminal\pp-term\mavis-installer-4-main-windows.py
...
set "MAVIS_PATH_CPP=C:\Users\%USERNAME%\p-terminal\pp-term\peharge-cpp-compier"
set "MAVIS_PATH_C=C:\Users\%USERNAME%\p-terminal\pp-term\peharge-c-compiler"
