...
COMMANDS = [
    ...
    "print('Hello, World!')", "len([1, 2, 3])", "range(10)", "sum([1, 2, 3])", "input('Enter: ')",
    "for i in range(5): print(i)", "def greet(name): return f'Hello {name}'", "lambda x: x * 2", "map(int, ['1', '2'])", "filter(bool, [0, 1, '', 'a'])",
    "import math", "math.sqrt(16)", "import os", "os.getcwd()", "os.listdir('.')",
    "open('file.txt', 'w').write('test')", "try: x = 1/0 except ZeroDivisionError: pass", "class Person: pass", "from datetime import datetime",
    "datetime.now()", "import sys", "sys.argv", "enumerate(['a', 'b'])", "zip([1, 2], ['a', 'b'])",
    "sorted([3, 1, 2])", "reversed([1, 2, 3])", "list(set([1, 1, 2]))", "isinstance(3, int)", "type('x')",
    "help(str)", "dir(list)", "globals()", "locals()", "eval('2 + 2')",
    "exec('print(123)')", "__name__", "__main__", "assert 2 + 2 == 4", "del x",
    "pass", "break", "continue", "not True", "all([True, True])",
