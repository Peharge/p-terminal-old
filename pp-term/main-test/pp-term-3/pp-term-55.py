...
COMMANDS = [
    "p", "p git", "p git mavis", "p git mavis-web",
    "p git simon", "p htop", "p ls", "p ls mavis"
]
...
def input_line(prompt):
    ...
    while True:
        ...
        # Pfeiltasten: führen mit '\xe0' die Spezialtaste ein
        if ch == '\xe0':
            arrow = msvcrt.getwch()
            # Oben
            if arrow == 'H' and history and history_index > 0:
                history_index -= 1
                # Ganze Zeile löschen und neu drucken
